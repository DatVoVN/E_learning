...
const CourseItem = () => {
  return (
    <div className="bg-white border border-gray-200 p-4 rounded-2xl dark:border-opacity-10 dark:bg-gray-700">
      ...
      <div className="pt-4">
        ...
        <div className="flex items-center gap-3 mb-5 text-gray-500 text-xs dark:text-gray-950">
