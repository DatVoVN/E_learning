...
const CourseItem = () => {
  return (
    <div className="bg-white border border-gray-200 p-4 rounded-2xl">
      ...
      <div className="py-4">
      <h3 className='font-bold text-lg mb-10'>Xây dựng NextJs Pro</h3>
      <div className="flex items-center justify-between">
        <span className='text-xs bg-opacit-10 rounded-full px-3 py-1 bg-primary text-primary'>30h25</span>
