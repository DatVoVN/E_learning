  ...
  return (
    <div className="bg-white border border-gray-200 p-4 rounded-2xl">
      ...
      <div className="flex items-center justify-between">
        <span className='text-xs bg-opacity-10 rounded-full px-3 py-1 bg-gray-100 text-gray-500'>30h25</span>
        <span className='font-semibold text-primary'>790.000</span>
      </div>
      <Link href="#" className='flex items-center justify-center w-full mt-10 rounded-lg bg-primary h-12 text-white font-semibold'>Xem chi tiết</Link>
      </div>
    </div>
  );
};
